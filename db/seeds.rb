...
employer_csv_file_path = Rails.root.join("db", "generated_employers.csv")
...
apprenticeship_csv_file_path = Rails.root.join("db", "updated_100_generated_apprenticeships.csv")
